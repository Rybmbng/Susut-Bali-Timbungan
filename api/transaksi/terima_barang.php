...
<div class="mb-4 flex items-center"> 
    <form method="GET" action="list_pl.php" class="flex flex-wrap"> 
        ...
        <div class="mr-4 flex items-center">
            ...
            <input type="date" name="start_date" id="start_date" placeholder="Mulai" value="<?php echo isset($_GET['start_date']) ? htmlspecialchars($_GET['start_date']) : ''; ?>" class="border border-gray-300 p-2" onchange="updateDateRangeDisplay()">
            <span class="mx-2">s/d</span>
            <input type="date" name="end_date" id="end_date" placeholder="Akhir" value="<?php echo isset($_GET['end_date']) ? htmlspecialchars($_GET['end_date']) : ''; ?>" class="border border-gray-300 p-2" onchange="updateDateRangeDisplay()">
        </div>
    ...
    <div class="mt-6 flex justify-between">
        <a href="?page=<?php echo $page > 1 ? $page - 1 : 1; ?>&search=<?php echo urlencode($searchKeyword); ?>&search_date=<?php echo urlencode($searchDate); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Sebelumnya
        </a>
        <span class="self-center">Page <?php echo $page; ?> of <?php echo $totalPages; ?></span>
        <a href="?page=<?php echo $page < $totalPages ? $page + 1 : $totalPages; ?>&search=<?php echo urlencode($searchKeyword); ?>&search_date=<?php echo urlencode($searchDate); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Selanjutnya
        </a>
    </div>
</div>
